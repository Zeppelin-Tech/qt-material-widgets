...
QtMaterialSliderPrivate::QtMaterialSliderPrivate(QtMaterialSlider *q) : q_ptr(q) {}
...
int QtMaterialSliderPrivate::valueFromPosition(const QPoint &pos) const {
    ...
    return QtMaterialStyle::sliderValueFromPosition(q->minimum(), q->maximum(),
                                                    position - QT_MATERIAL_SLIDER_MARGIN, span,
