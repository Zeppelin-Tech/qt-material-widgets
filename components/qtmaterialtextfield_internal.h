...
inline qreal QtMaterialTextFieldStateMachine::progress() const { return m_progress; }
...
inline QPointF QtMaterialTextFieldLabel::offset() const { return QPointF(m_posX, m_posY); }
