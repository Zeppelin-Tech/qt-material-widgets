...
inline QIcon QtMaterialCheckableIcon::icon() const { return m_icon; }
...
inline QColor QtMaterialCheckableIcon::color() const { return m_color; }
...
inline qreal QtMaterialCheckableIcon::iconSize() const { return m_iconSize; }
...
inline qreal QtMaterialCheckableIcon::opacity() const { return m_opacity; }
