...
class QtMaterialSliderStateMachine : public QStateMachine {
  ...
  public:
    QtMaterialSliderStateMachine(QtMaterialSlider *slider, QtMaterialSliderThumb *thumb,
...
inline qreal QtMaterialSliderThumb::borderWidth() const { return m_borderWidth; }
...
inline QColor QtMaterialSliderThumb::borderColor() const { return m_borderColor; }
