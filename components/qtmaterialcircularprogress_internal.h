...
inline qreal QtMaterialCircularProgressDelegate::dashOffset() const { return m_dashOffset; }
...
inline qreal QtMaterialCircularProgressDelegate::dashLength() const { return m_dashLength; }
